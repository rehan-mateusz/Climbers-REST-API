...
class Account(AbstractUser):
    ...
    weight              = models.IntegerField(verbose_name='weight', blank=True,
        null=True, validators=[MaxValueValidator(150), MinValueValidator(10)])
    boulder_grade       = models.CharField(blank=True, max_length=8)
    lead_grade          = models.CharField(blank=True, max_length=8)
    toprope_grade       = models.CharField(blank=True, max_length=8)
